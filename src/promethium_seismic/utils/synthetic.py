...
def add_noise(
    ...
    Example:
        >>> from promethium_seismic.utils import generate_synthetic_traces, add_noise
...
def create_missing_traces(
    ...
    Example:
        >>> from promethium_seismic.utils import generate_synthetic_traces, create_missing_traces
        >>> traces, _ = generate_synthetic_traces()
