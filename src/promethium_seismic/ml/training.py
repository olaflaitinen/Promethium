...
def train_model(
    ...
    for epoch in range(epochs):
        ...
        # Approximate PSNR from the validation loss. This assumes the data
        # is standardised, so the peak value is taken from that convention
        # rather than measured from the batch.
        psnr = calculate_psnr(avg_val_loss)
